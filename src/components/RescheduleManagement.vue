...
defineEmits(["approve", "edit-schedule", "reject"]);
</script>
      ...
      >
        <div class="p-6">
          ...
          <div class="grid md:grid-cols-2 gap-4 mt-5">
            ...
            <div class="bg-slate-50 rounded-2xl p-4">
              <p class="text-xs font-semibold text-slate-500 uppercase">Jam</p>
          ...
          <div class="bg-blue-50 rounded-2xl p-4 mt-4">
            <p class="text-xs font-semibold text-blue-600 uppercase">Alasan</p>
